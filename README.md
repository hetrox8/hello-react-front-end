...
**hello-react-front-end** Is a React app that consumes an API endpoint from [hello-rails-back-end](https://github.com/hetrox8/hello-rails-back-end) Rails app and renders the received data in the browser.
...
Use the following URL to clone this project:
   ...
   https://github.com/hetrox8/hello-react-front-end.git
